...
/**
 * Variantes visuelles Déclaration (decl-card, dept-grid, accordéons) + titres hero.
 */
class UpdateCmsDeclarationPageVisualForm extends Migration
{
    ...
    public function up(): void
    {
        ...
        $this->updateLocale('fr', $this->metaFr(), $this->blocksFr());
        $this->updateLocale('en', $this->metaEn(), $this->blocksEn());
    }
     ...
     */
    private function updateLocale(string $locale, array $meta, array $blocks): void
    {
        ...
        return [
            ...
            [
                ...
                'cards'   => [
                    ...
                    [
                        ...
                        'href'        => 'mailto:contact@govgenz.org',
                        'value'       => 'Alerte',
                        'unit'        => 'Lire la position complète',
                    ],
                ],
            ],
            [
                ...
                'paragraphs' => [
                    ...
                    'Un noyau exécutif central appuyé par 7 départements spécialisés — Programme Paikady Taninjanaka.',
                ],
            ],
            [
                'type'    => 'cards_grid',
                'variant' => 'dept_cards',
                'cards'   => $this->deptCardsFr(),
            ],
            [
                'type'       => 'section_text',
                'paragraphs' => [
                    ...
                    'Chaque secteur clé de Madagascar est couvert par une équipe dédiée — bâtir, innover, servir le peuple.',
                ],
            ],
            [
                'type' => 'html',
                'html' => '<div class="decl-teams-header"><h3>Équipes sectorielles — GoV Gen Z Madagascar</h3><span>14 secteurs · Madagascar</span></div>',
            ],
            ['type' => 'sectors_grid'],
            [
                'type'       => 'section_text',
            ...
            [
                ...
                'paragraphs' => [
                    ...
                    'Nos annonces officielles de collaboration avec des organisations, institutions et réseaux citoyens qui partagent nos valeurs.',
                ],
            ],
            [
                'type'    => 'cards_grid',
                'variant' => 'declaration_cards',
                'cards'   => $this->partnershipCardsFr(),
            ],
            [
                'type'       => 'section_text',
                'paragraphs' => [
        ...
        return [
            ...
            [
                ...
                'paragraphs' => [
                    ...
                    'A central executive core supported by 7 specialized departments (Paikady Taninjanaka programme).',
                ],
            ],
            [
                'type'    => 'cards_grid',
                'variant' => 'dept_cards',
                'cards'   => $this->deptCardsEn(),
            ],
            [
                'type'       => 'section_text',
                'paragraphs' => [
                    'Field teams',
                    '14 sector teams',
                    'Each key sector in Madagascar is covered by a dedicated team.',
                ],
            ],
            [
                'type' => 'html',
                'html' => '<div class="decl-teams-header"><h3>Sector teams — GoV Gen Z Madagascar</h3><span>14 sectors · Madagascar</span></div>',
            ],
            ['type' => 'sectors_grid'],
            [
                'type'       => 'section_text',
                'paragraphs' => [
                    ...
                    'Who we act for, what guides us, how we work, and where we are headed.',
                ],
            ],
            [
                'type'    => 'cards_grid',
            ...
            [
                ...
                'paragraphs' => [
                    ...
                    'Official collaboration announcements with organizations and networks that share our values.',
                ],
            ],
            [
                'type'    => 'cards_grid',
                'variant' => 'declaration_cards',
                'cards'   => $this->partnershipCardsEn(),
            ],
            [
                'type'       => 'section_text',
                'paragraphs' => [
     ...
     * @return list<array<string, mixed>>
     */
    private function deptCardsFr(): array
    {
        return [
            ['title' => 'Coordination', 'description' => 'Direction générale, alignement entre équipes, pilotage des décisions stratégiques du mouvement.', 'href' => 'mailto:coordination@govgenz.org'],
            ['title' => 'Sécurité', 'description' => 'Protection des membres, gestion des risques, sécurité des données et continuité des opérations.', 'href' => 'mailto:securite@govgenz.org'],
            ['title' => 'Communication', 'description' => 'Relations presse, réseaux sociaux, contenus publics, image institutionnelle du mouvement.', 'href' => 'mailto:communication@govgenz.org'],
            ['title' => 'Partenariats', 'description' => 'Relations avec les PTF, organisations internationales, ambassades et alliances citoyennes.', 'href' => 'mailto:partnerships@govgenz.org'],
            ['title' => 'Ressources humaines', 'description' => 'Recrutement des volontaires, formation, bien-être des membres, gestion des compétences.', 'href' => 'mailto:rh@govgenz.org'],
            ['title' => 'Project Management', 'description' => 'Suivi opérationnel des projets, coordination des équipes terrain, reporting et indicateurs.', 'href' => 'mailto:projets@govgenz.org'],
            ['title' => 'Finances', 'description' => 'Gestion transparente des ressources, budgets, audits internes et reporting financier.', 'href' => 'mailto:finances@govgenz.org'],
        ];
    }
     ...
     * @return list<array<string, mixed>>
     */
    private function deptCardsEn(): array
    {
        return [
            ['title' => 'Coordination', 'description' => 'General management, team alignment, strategic decision-making for the movement.', 'href' => 'mailto:coordination@govgenz.org'],
            ['title' => 'Security', 'description' => 'Member protection, risk management, data security and operational continuity.', 'href' => 'mailto:securite@govgenz.org'],
            ['title' => 'Communication', 'description' => 'Press relations, social media, public content, institutional image.', 'href' => 'mailto:communication@govgenz.org'],
            ['title' => 'Partnerships', 'description' => 'Relations with donors, international organizations, embassies and citizen alliances.', 'href' => 'mailto:partnerships@govgenz.org'],
            ['title' => 'Human resources', 'description' => 'Volunteer recruitment, training, member wellbeing, skills management.', 'href' => 'mailto:rh@govgenz.org'],
            ['title' => 'Project management', 'description' => 'Operational project follow-up, field team coordination, reporting and indicators.', 'href' => 'mailto:projets@govgenz.org'],
            ['title' => 'Finance', 'description' => 'Transparent resource management, budgets, internal audits and financial reporting.', 'href' => 'mailto:finances@govgenz.org'],
        ];
    }
     ...
     * @return list<array<string, mixed>>
     */
    private function partnershipCardsFr(): array
    {
        return [
            [
     ...
     * @return list<array<string, mixed>>
     */
    private function partnershipCardsEn(): array
    {
        return [
            [
     ...
     * @return list<array<string, mixed>>
     */
    private function ethicsFr(): array
    {
        return [
            [
     ...
     * @return list<array<string, mixed>>
     */
    private function ethicsEn(): array
    {
        return [
            [
