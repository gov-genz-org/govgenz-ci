...
<div class="pp-repeat-row row g-2 align-items-md-center mb-2">
    <div class="col-12 col-md-5">
        <label class="form-label small mb-0 d-md-none">Article</label>
    ...
    <div class="col-12 col-md-2">
        <label class="form-label small mb-0 d-md-none">Quantité</label>
    ...
    <div class="col-12 col-md">
        <label class="form-label small mb-0 d-md-none">Précisions</label>
