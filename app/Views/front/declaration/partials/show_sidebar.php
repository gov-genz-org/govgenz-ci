...
?>
<aside class="project-sidebar declaration-program-show__sidebar" aria-label="<?= esc(lang('Declaration.show_sidebar_aria'), 'attr') ?>">

    <div class="widget">
        <div class="widget-title"><?= esc(lang('Declaration.show_widget_key_info')) ?></div>
        <?php if ($dateLabel !== '') : ?>
            <div class="widget-row">
                <span><?= esc(lang('Declaration.show_widget_published')) ?></span>
                <span><?= esc($dateLabel) ?></span>
            </div>
        <?php endif; ?>
        <?php if ($kindLabel !== '') : ?>
            <div class="widget-row">
                <span><?= esc(lang('Declaration.show_widget_kind')) ?></span>
                <span><?= esc($kindLabel) ?></span>
            </div>
        <?php endif; ?>
        <?php if ($sectionLabel !== '') : ?>
            <div class="widget-row">
                <span><?= esc(lang('Declaration.show_widget_section')) ?></span>
    ...
    <?php if ($actionCtas !== []) : ?>
        <div class="widget">
            <div class="widget-title"><?= esc(lang('Declaration.show_widget_actions')) ?></div>
            <p class="projects-program-show__widget-lead"><?= esc(lang('Declaration.show_widget_actions_lead')) ?></p>
            <div class="widget-cta declaration-program-show__widget-cta">
                <?php foreach ($actionCtas as $cta) :
                    ...
                    <a
                        ...
                        <?php if (str_starts_with($href, 'mailto:')) : ?>
                            rel="noopener"
                        <?php endif; ?>
    ...
    <div class="widget" id="declaration-share">
        <div class="widget-title"><?= esc(lang('Declaration.show_widget_share')) ?></div>
        <div
            ...
            data-share-copied="<?= esc(lang('Declaration.show_share_copied'), 'attr') ?>"
            data-share-tiktok-done="<?= esc(lang('Declaration.show_share_tiktok_done'), 'attr') ?>"
        >
            <div class="projects-program-show__share-url-head">
                <p class="projects-program-show__widget-lead"><?= esc(lang('Declaration.show_widget_share_lead')) ?></p>
                <button
                    type="button"
                    class="projects-program-show__share-icon-btn"
                    data-project-share-copy
                    aria-label="<?= esc(lang('Declaration.show_share_copy_aria'), 'attr') ?>"
                    title="<?= esc(lang('Declaration.show_share_copy_aria'), 'attr') ?>"
                >
            ...
            <?php if ($shareQrImageUrl !== '') : ?>
                <div class="projects-program-show__share-qr-wrap">
                    <p class="projects-program-show__share-qr-label"><?= esc(lang('Declaration.show_share_qr_label')) ?></p>
            ...
            <?php endif; ?>
            <div class="projects-program-show__share-social" role="navigation" aria-label="<?= esc(lang('Declaration.show_share_social_aria'), 'attr') ?>">
    ...
    <?php if ($relatedDeclarations !== []) : ?>
        <div class="widget">
            <div class="widget-title"><?= esc(lang('Declaration.show_widget_see_also')) ?></div>
            <div class="projects-program-show__see-also">
                <?php foreach ($relatedDeclarations as $rel) : ?>
                    <a href="<?= esc(declaration_public_url($rel['slug']), 'attr') ?>"><?= esc($rel['title']) ?></a>
                <?php endforeach; ?>
                <a href="<?= esc($declarationListUrl, 'attr') ?>" class="is-muted"><?= esc(lang('Declaration.back_to_list')) ?></a>
            </div>
        </div>
    <?php else : ?>
        <div class="widget">
            <div class="widget-title"><?= esc(lang('Declaration.show_widget_see_also')) ?></div>
            <div class="projects-program-show__see-also">
                <a href="<?= esc($declarationListUrl, 'attr') ?>"><?= esc(lang('Declaration.back_to_list')) ?></a>
            </div>
        </div>
    <?php endif; ?>
