...
use App\Filters\CspHeaderFilter;
use App\Filters\SiteContextFilter;
...
class Filters extends BaseFilters
{
    ...
    public array $aliases = [
        ...
        'sitecontext'   => SiteContextFilter::class,
        'authadmin'     => AuthAdminFilter::class,
        'adminonly'     => AdminOnlyFilter::class,
        'cspheaders'    => CspHeaderFilter::class,
    ];
    ...
    public function __construct()
    {
        if (ENVIRONMENT === 'production') {
            $this->required['after'] = array_values(array_filter(
                $this->required['after'],
                static fn (string $f): bool => $f !== 'toolbar',
            ));
        }
    }
}
