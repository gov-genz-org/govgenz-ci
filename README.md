...
Merge **`develop` → `main`** : déploiement prod FTP puis tag Git auto (`v1.1.0`, `v1.2.0`, … — incrément **mineur**). Le job CI met à jour `VERSION` et `CHANGELOG.md` sur `develop` (commit `release: increase next develop version`).  
